...
const mewsPropertyKey: "mews-property" = "mews-property";
const hero1 = assetsConfig[mewsPropertyKey][5].src;
const hero2 = assetsConfig[mewsPropertyKey][6].src;
const hero3 = assetsConfig[mewsPropertyKey][7].src;
